...
- **WiFi picker modal** (`src/components/ui/WifiModal.tsx`):
  ...
  - **Footer.** Rescan button on the left (disabled while the radio is off); "WiFi Settings" ghost button on the right opens Windows Wi-Fi settings (radio on/off lives in the OS).
