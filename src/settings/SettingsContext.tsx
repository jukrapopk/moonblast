...
export interface Settings {
  ...
  customization: { show_time: boolean; show_wifi: boolean; show_battery: boolean; show_audio: boolean };
...
export const DEFAULT_SETTINGS: Settings = {
  ...
  customization: { show_time: true, show_wifi: true, show_battery: true, show_audio: true },
  machines: [],
  app_shortcuts: [],
};
